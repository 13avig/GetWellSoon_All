...
class ParseIndividual extends PuppeteerHelper {
  ...
  async execute(url) {
    ...
    try {
      ...
      axios({
        method: "post",
        url: "trials/update/trialId",
        data: {
          isDeleted: false,
          first_posted = json.first_posted,
          last_updated = json.last_updated,
          study_start = json.study_start,
          study_completion = json.study_completion,
          primary_outcome = json.primary_outcome,
          secondary_outcome = json.secondary_outcome,
          brief_title = json.brief_title,
          official_title = json.official_title,
          summary = json.summary,
          description = json.description,
          study_type = json.study_type,
          study_phase = json.study_phase,
          ...
          inclusion_criteria = json.inclusion_criteria,
          exclusion_criteria = json.exclusion_criteria,
          gender = json.gender,
          min_age = json.min_age,
          max_age = json.max_age,
          nct_id = json.nct_id,
          other_ids = json.other_ids,
          responsible_party = json.responsible_party,
          study_sponsor = json.study_sponsor,
          collaborators = json.collaborators,
          investigators = json.investigators
        }
      })
